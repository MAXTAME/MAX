--[[
    ...
    | \_/ |/ ___ \ /  \
    |_| |_/_/   \_/_/\_\
           تم كتابه وبرمجه السورس من قبل كاسبر وسيف
--]]
--------------------------------------
...
info = '💬┇من قبل ⌁≻ ['..result.first_name_..'](t.me/'..(result.username_ or 'MAXteam')..')\n'..text
...
send(msg.chat_id_, msg.id_, 1, '☑┇المضافه الملفات : \n '..keko..'\n ---------------------- \n\n✔┇الملفات المفعله \n'..files_MAX2..'', 1, 'html')
end
text = msg.content_.text_
if text then
...
ts23 = ts23 .. "\n❗┇لا ترفع ملفات غير ملفات سورس ماكس"
end
database:sadd("files"..bot_id,name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, "✔┇تم تفعيل الملف بنجاح {"..name_t[2]..".lua}\n"..ts23, 1, 'html')
else
send(msg.chat_id_, msg.id_, 1, '🚫┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لا ترفع ملف غير ملفات ماكس قد يسبب في اتلاف بوتك \n📂┇[ملفات سورس ماكس](t.me/MAXFiles)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '🚫┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لا ترفع ملف غير ملفات ماكس قد يسبب في اتلاف بوتك \n📂┇[ملفات سورس ماكس](t.me/MAXFiles)', 1, 'md')
end
...
send(msg.chat_id_, msg.id_, 1, "🕡┇ انتضر ثواني وسيتم احضار \n 📁┇الملف : {"..name_t[2]..".lua}", 1, 'html')
local MAXe = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
...
if (text and text == 'مسح كليشه المبرمح') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
redis:del('MAX:'..bot_id..'text_sudo', text)
send(msg.chat_id_, msg.id_, 1, '✔┇تم مسح كليشه المبرمج ', 1, 'html')
return "MAX"
end
...
if (text and text == 'وضع كليشه المبرمج') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال كليشه المبرمج', 1, 'html')
...
◾️┇ 《 مسح المحظورين》 لالغاء الحظر عن الكل
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
♦️┇ 《 تعين/مسح 》ايدي
♦┇ا 《 ضف/مسح 》صلاحيه

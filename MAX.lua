...
local curl = 'curl "' .. maxe .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'TshAkE.txt' .. '"'
io.popen(curl)
end
...
if text:match("رفع امر (.*)") then 
local max_edis = {string.match(text, "^رفع امر (.*)$")}
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nadam or 9647723177600), (naadam or "TshAke TEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
if (text and text == "رفع صلاحيه" and is_creator(msg)) then 
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
...
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيء") then 

...
{
{text = ''..(channel_mx or "MAX TAME")..'', url=''..(channel_user_mx or 't.me/MAX TAME')..''},
},
}
...
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apow[2] or 'MAXTAME')..')\n☑┇تم رفع منشئ في البوت'
else
texmx = '✖┇خطاء'
end
...
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apmd[2] or 'MAXTAME')..')\n☑┇تم رفعه ادمن'
else
texmx = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texmx, 1, 'md')
...
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apba[2] or 'MAXTAME')..')\n☑┇تم حظره من المجموعه'
...
local hash =  'MAX:'..bot_id..'gbanned:'
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apbll[2] or 'MAXTAME')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'MAX:'..bot_id..'gbanned:'
if result.id_ then
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apid[2] or 'MAXTAME')..')\n🚫┇تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texmx = '✖┇خطاء'
end
...
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apsi[2] or 'MAXTAME')..')\n🚫┇تم كتمه من البوت'
end
else
texmx = '✖┇خطاء'
end
...
texmx = '👨┇العضو ⌁≻ ['..result.title_..'](t.me/'..(apki[2] or 'MAXTAME')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texmx = '✖┇خطاء'

...
{
{text = ''..(channel_ts or "MAX TEAM")..'', url=''..(channel_user_ts or 't.me/MAXTAME')..''},
},
}
...
if tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم قفل اليوزر")
else
...
if (text == "ادمن" or text == "اداري" or text == "مميز" or text == "لا شيئ") then 
...
info = '👨┇العضو ➣ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'MAXTAME')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local keko_text = {
ذ صورتك القديمه طالع جنك بسطال😹",

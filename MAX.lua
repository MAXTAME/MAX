...
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق مآكس لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
local MAX_new_text = MAX_new_text:gsub('#auto',(ikeko_text or 'لا يوجد'))
...
if text == 'الاسرع' and database:get('MAX:'..bot_id..'lock_geam'..msg.chat_id_) then
...
if text == 'حزوره' and database:get('MAX:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('MAX:'..bot_id..'l:id1'..msg.chat_id_)
katu = {'الجرس','عقرب الساعه','السمك','المطر','5','جامعه الدول العربيه','الكتاب','البسمار','7','الكعبه','بيت الشعر','لهانه','انا','امي','الابره','الساعه','22','غلط','كم الساعه','البيتنجان','البيض','المرايه','الضوء','الهواء','الضل','العمر','القلم','المشط','الحفره','البحر','الثلج','الاسفنج','الصوت','بلم'};
name = katu[math.random(#katu)]
database:set('MAX:'..bot_id..'klmoa'..msg.chat_id_,name)
...
zah = '*💎¦ ليس لديك مجوهرات \n📬¦ للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,zah, 1, 'md')
else
zah = '*💎¦ عدد مجوهراتك الحاليه  ('..(database:get('MAX:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
zah1 = '*💎¦ مجموع مجوهراتك  ('..(database:get('MAX:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'

send(msg.chat_id_, msg.id_, 1,''..zah..'\n'..zah1..'', 1, 'md')
end
end
...
database:set('MAX:'..bot_id..'gamepoint' .. msg.chat_id_, kara[2] or 50)
...
if (text:match("^م5$") or text == "م٤") and is_sudo(msg) then
local h4 = redis:get('MAX:'..bot_id..'h4')
local text =  [[
🎖┇اوامر المطور
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉

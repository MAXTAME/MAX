...
local var = false
	local hash =  'tshake:'..bot_id..'muted:'..chat_id
...
local var = false
  local hashs =   'tshake:'..bot_id..'admins:'
...
local var = false
local hash =   'tshake:'..bot_id..'creator:'..chat_id
...
local var = false
local hash =   'tshake:'..bot_id..'mods:'..chat_id
local mod = database:sismember(hash, user_id)
	local hashs =   'tshake:'..bot_id..'admins:'
local admin = database:sismember(hashs, user_id)
	local hashss =   'tshake:'..bot_id..'owners:'..chat_id
local owner = database:sismember(hashss, user_id)
	local hashss =   'tshake:'..bot_id..'creator:'..chat_id
local creator = database:sismember(hashss, user_id)
	local hashsss =   'tshake:'..bot_id..'vipgp:'..chat_id
...
local var = false
local hash =   'tshake:'..bot_id..'owners:'..chat_id
...
local var = false
	local hash =  'tshake:'..bot_id..'banned:'..chat_id
local banned = database:sismember(hash, user_id)
	 if banned then
	var = true
	 end
